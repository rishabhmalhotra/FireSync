...
"findservices":
    ...
    Arguments:
        - addr=None: a device address, to se only for services on a
          specific device
        - name=None: a service name string, to se only for a service with a
          specific name
        - servicetype=None: can be RFCOMM or OBEX to se only for RFCOMM or
